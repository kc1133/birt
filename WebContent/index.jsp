	...
	<div>
		...
		<div style="float: left;width: 25%;">
			...
			<legend >
				...
				<ul>
				<li><a href="/BirtIntegration/Reports.jsp">Hello World Report</a></li>
				...
				<li> <a href="#" onclick="generateReport('list.rptdesign')">Pets Details Report</a></li>
				<li> <a href="#" onclick="generateReport('some.rptdesign')">Pets Details Report</a></li>
				<li> <a href="#" onclick="generateReport('usertxn.rptdesign')">User Transaction Report</a></li>
				</ul>
			</fieldset>
		</div>
